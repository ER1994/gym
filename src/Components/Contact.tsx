...
const Contact = () => {
    return (
        <>
            <section className="bg-white py-20 px-14 lg:py-[120px] overflow-hidden relative z-[-1]">
                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">
                                            ul. Przekątna 100/12 Poznań 61-883
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                                <h4 className="mb-1 text-xl font-bold text-dark text-center">NAPISZ DO NAS</h4>
                                <form>
                                    <ContactInputBox
                                        type="text"
                                        name="name"
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-opacity-90 hover:text-custom-blue"
                                        >
                                            Wyślij wiadomość
                                        </button>
                                    </div>
