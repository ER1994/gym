...
const Footer = () => {
    return (
        <div className='relative bottom-0 z-0 text-[0.6rem]'>
            <div className=" w-full flex justify-center md:items-end bg-gray-600">
                <div
                    className="flex pt-[2rem] md:pt-[3rem] flex-col justify-start items-center md:justify-center md:items-center relative z-10">
                    <div
                        className="flex flex-col items-center md:gap-[3rem] lg:gap-[12rem] justify-start xl:justify-center xl:space-x-8 md:flex-row">
                        <div className="flex flex-col gap-1 items-center space-x-4 w-[150px]">
                            <div className="cursor-pointer w-20 flex justify-center">
                                <svg className={'w-10 h-10 md:w-20 md:h-20 '} version="1.1" id="Uploaded to svgrepo.com"
                                     xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                     viewBox="0 0 32 32" xmlSpace="preserve" fill="#FFFFFF">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <g>
                                            <g>
                                                <path className="open_een"
                                                      d="M16,30C8.28,30,2,23.72,2,16c0-3.998,3.252-7.25,7.25-7.25S16.5,12.002,16.5,16 c0,3.446,2.804,6.25,6.25,6.25S29,19.446,29,16c0-7.168-5.832-13-13-13C12.057,3,8.372,4.76,5.889,7.829 C5.716,8.043,5.399,8.076,5.186,7.903C4.971,7.729,4.938,7.415,5.111,7.2C7.785,3.895,11.753,2,16,2c7.72,0,14,6.28,14,14 c0,3.998-3.252,7.25-7.25,7.25S15.5,19.998,15.5,16c0-3.446-2.804-6.25-6.25-6.25S3,12.554,3,16c0,7.168,5.832,13,13,13 c3.943,0,7.629-1.76,10.112-4.829c0.173-0.215,0.489-0.248,0.703-0.074c0.215,0.174,0.248,0.488,0.074,0.703 C24.215,28.104,20.247,30,16,30z"></path>
                                                <path className="open_een"
                                                      d="M8.5,17.5c-1.103,0-2-0.897-2-2s0.897-2,2-2s2,0.897,2,2S9.603,17.5,8.5,17.5z M8.5,14.5 c-0.551,0-1,0.449-1,1s0.449,1,1,1s1-0.449,1-1S9.051,14.5,8.5,14.5z"></path>
                                                <path className="open_een"
                                                      d="M23.5,17.5c-1.103,0-2-0.897-2-2s0.897-2,2-2s2,0.897,2,2S24.603,17.5,23.5,17.5z M23.5,14.5 c-0.551,0-1,0.449-1,1s0.449,1,1,1s1-0.449,1-1S24.051,14.5,23.5,14.5z"></path>
                                            </g>
                                            <g>
                                                <path className="open_een"
                                                      d="M16,30C8.28,30,2,23.72,2,16c0-3.998,3.252-7.25,7.25-7.25S16.5,12.002,16.5,16 c0,3.446,2.804,6.25,6.25,6.25S29,19.446,29,16c0-7.168-5.832-13-13-13C12.057,3,8.372,4.76,5.889,7.829 C5.716,8.043,5.399,8.076,5.186,7.903C4.971,7.729,4.938,7.415,5.111,7.2C7.785,3.895,11.753,2,16,2c7.72,0,14,6.28,14,14 c0,3.998-3.252,7.25-7.25,7.25S15.5,19.998,15.5,16c0-3.446-2.804-6.25-6.25-6.25S3,12.554,3,16c0,7.168,5.832,13,13,13 c3.943,0,7.629-1.76,10.112-4.829c0.173-0.215,0.489-0.248,0.703-0.074c0.215,0.174,0.248,0.488,0.074,0.703 C24.215,28.104,20.247,30,16,30z"></path>
                            ...
                            <p className="w-60 text-[0.5rem] md:text-[0.8rem] font-semibold leading-normal text-white text-center"
                               style={{fontFamily: 'Roboto, sans-serif'}}>STUDIO TRENINGOWE BALANCE</p>
                        </div>
                        <div
                            className="mt-12 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-12 sm:gap-y-0 w-full md:w-auto sm:gap-x-15 place-items-center">
                            <div
                                className="w-[8rem] md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                                <h2 className="font-bold xl:font-semibold leading-4 xl:leading-5 text-white text-[0.8rem]">Informacje</h2>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                                    O nas
                                </button>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                                    Przewodnik - korzystanie z maszyn
                                </button>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                            ...
                            <div
                                className="w-[8rem] md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                                <h2 className="font-bold xl:font-semibold leading-4 xl:leading-5 text-white text-[0.8rem]">Usługi</h2>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                                    Oferta dla firm
                                </button>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                            ...
                            <div className="w-[8rem] xl:w-72 flex justify-start items-start flex-col space-y-6">
                                <h2 className="font-bold xl:font-semibold leading-4 xl:leading-5 text-white text-[0.8rem]">Godziny
                                    otwarcia</h2>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100 font-bold">
                                    Poniedziałek - Piątek:
                                </button>
                                <button className="text-left hover:text-gray-400 leading-none text-gray-100">
                                    7:00am - 21:00pm
                    ...
                    <div
                        className="mt-12 flex flex-col-reverse w-full ">
                        <div className={'w-full flex justify-start'}>
                            <p className="mt-2 leading-none text-white">2020 The Good Company.
                                Wszystkie parawa zastrzeżone</p>
                        </div>
                        <div className={'flex flex-col gap-4 min620:flex-row justify-between'}>
                            <div
                                className="flex gap-4 justify-start">
                                <button className="leading-none text-white hover:text-gray-300">
                                    Warunki umowy
                                </button>
                                <button className="leading-none text-white hover:text-gray-300">
                            ...
                            <div
                                className="flex justify-center min620:justify-end w-full items-center space-x-6 ">
