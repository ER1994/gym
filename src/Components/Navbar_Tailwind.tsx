                    ...
                    <div className="flex items-center justify-between -mx-4">
                        ...
                        <div className="flex items-center justify-between w-full px-4">
                            ...
                            <div className="justify-end hidden pr-16 sm:flex ">
                                ...
                                >
                                    <svg className="w-7 h-7 stroke-current" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg" onMouseEnter={() => setHoverLog(true)}
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path
                                                ...
                                                stroke={isHoverLog ? "#048dcd" : "#000000"}
                                                strokeWidth="0.8399999999999999" strokeLinejoin="round"></path>
                                            <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z"
                                                  stroke={isHoverLog ? "#048dcd" : "#000000"}
                                                  strokeWidth="0.8399999999999999" strokeLinecap="round"
                                ...
                                >
                                    <svg
                                        className="w-6 h-6 border-2 border-black rounded-md transition-transform duration-500 hover:rotate-180 hover:border-custom-blue"
                                        ...
                                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <path d="M4 12H20M12 4V20" stroke={isHoverJoin ? "#048dcd" : "#000000"}
                                                  strokeWidth="0.672" strokeLinecap="round"
                                                  strokeLinejoin="round"></path>
                                        </g>
                                    </svg>
                                    <p className={"font-light text-xs"} style={{fontFamily: 'Roboto, sans-serif'}}>JOIN
                                        US!</p>
                                </Link>
                            </div>
                        </div>
