        ...
        <section className="py-20 lg:py-[120px]">
            <div className="container mx-auto">
                <div className="w-full px-4">
                    <div className="rounded-lg shadow-lg relative mx-auto max-w-[525px] overflow-hidden bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
                        <div className="mb-10 text-center md:mb-16">
                            <h4 className="mb-1 text-xl font-bold text-dark text-center">ZALOGUJ SIĘ</h4>
                        </div>
                        <form>
                        ...
                        <a
                            href="/#"
                            className="mb-2 inline-block text-base text-[#adadad] hover:text-primary hover:text-custom-blue"
                        >
                            Nie pamiętasz hasła?
                        </a>
                        <p className="text-base text-[#adadad]">
                            Nie masz konta?
                            <a href="/#" className="text-primary hover:text-custom-blue">
                                Zarejestruj się
                            </a>
                        </p>
                        <div>
